/////////////////////////////////////////////////////////////////////
// Standard headers for Cold Fusion extensions (CFX)
//
...
//
// @contents1 Cold Fusion Extension API | 
...
//        to a Cold Fusion Extension (CFX). An instance of
...
//              or created by a Cold Fusion extension (CFX)

// @class   Abstract class which represents a query used
//          or created by a Cold Fusion Extension (CFX). Queries
...
//                 strings (used extensively in the Cold Fusion 
//                 extension interface)
...
//                 by the Cold Fusion Extension (CFX) library 

// @class Abstract class which represents an exception thrown
//        during the processing of a Cold Fusion Extension (CFX)
//		  procedure.<nl>
//        <nl>Exceptions of this type can be thrown by
//		  the classes <c CCFXRequest>, <c CCFXQuery>, and 
//		  <c CCFXStringSet>. Your Cold Fusion Extension code must
...
//        Cold Fusion after the request is completed). 
//
...
//  thrown by DLL extension code propagate back into Cold Fusion. You
...
//     exceptions in Cold Fusion Extension DLL procedures: |
//	
//	try
//	{
//
